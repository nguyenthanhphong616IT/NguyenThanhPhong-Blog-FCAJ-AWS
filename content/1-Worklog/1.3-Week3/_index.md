...
| --- | ---- | ---------- | --------------- | ------------------ |
| 2 | Study Hybrid DNS architecture and Amazon Route 53 Resolver, including Inbound Endpoint, Outbound Endpoint, and Resolver Rules. | 04/05/2026 | 04/05/2026 | https://cloudjourney.awsstudygroup.com/ |
| 3 | Deploy the networking infrastructure using AWS CloudFormation and create the required AWS resources for Lab 10. | 05/05/2026 | 05/05/2026 | https://cloudjourney.awsstudygroup.com/ |
| 4 | Create a Key Pair, configure Security Groups, and connect to the EC2 Windows instance through Remote Desktop Protocol (RDP). | 06/05/2026 | 06/05/2026 | https://cloudjourney.awsstudygroup.com/ |
| 5 | Configure Route 53 Resolver Outbound Endpoint, Inbound Endpoint, and Resolver Rules for Hybrid DNS integration. | 07/05/2026 | 08/05/2026 | https://cloudjourney.awsstudygroup.com/ |
| 6 | Verify DNS resolution using **nslookup** and **ping**, then clean up all AWS resources after completing Lab 10. | 09/05/2026 | 10/05/2026 | https://cloudjourney.awsstudygroup.com/ |
